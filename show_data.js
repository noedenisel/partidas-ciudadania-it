...
document.addEventListener("DOMContentLoaded", function () {
    // Verificar si la bandera está establecida como "true" y eliminar los datos si es necesario
    ...
    // Escucha el evento click en el botón "Cerrar Ventana"
    const cerrarVentanaButton = document.getElementById("cerrar-ventana");
    cerrarVentanaButton.addEventListener("click", function () {
      // Cuando el usuario cierra la ventana desde show_data.html, establece la bandera como "true"
      localStorage.setItem("eliminarDatos", "true");
